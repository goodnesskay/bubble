...
<script src="{{ asset('dashboard/lib/jquery-flot/jquery.flot.js') }}" type="text/javascript"></script>
<script src="{{ asset('dashboard/lib/jquery-flot/jquery.flot.pie.js') }}" type="text/javascript"></script>
<script src="{{ asset('dashboard/lib/jquery-flot/jquery.flot.resize.js') }}" type="text/javascript"></script>
<script src="{{ asset('dashboard/lib/jquery-flot/plugins/jquery.flot.orderBars.js') }}" type="text/javascript"></script>
<script src="{{ asset('dashboard/lib/jquery-flot/plugins/curvedLines.js') }}" type="text/javascript"></script>
<script src="{{ asset('dashboard/lib/jquery.sparkline/jquery.sparkline.min.js') }}" type="text/javascript"></script>
<script src="{{ asset('dashboard/lib/countup/countUp.min.js') }}" type="text/javascript"></script>
